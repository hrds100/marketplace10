// Mock data for NFsTay Investment module — Investors pages
  ...
  past: [
    {
      ...
      propertyTitle: 'Seseh Beachfront Villa',
      propertyId: 1,
      title: 'Increase nightly rate by 10% for peak season',
      description: 'Align pricing with market comparables during June–September peak period.',
    ...
    },
    {
      ...
      propertyTitle: 'Marina Gate Apartment',
      propertyId: 2,
      title: 'List property on Booking.com',
      description: 'Expand distribution by adding Booking.com alongside existing Airbnb listing.',
    ...
    },
    {
      ...
      propertyTitle: 'Seseh Beachfront Villa',
      propertyId: 1,
      title: 'Convert to long-term rental',
      description: 'Switch from short-term Airbnb to 12-month tenancy agreement.',
