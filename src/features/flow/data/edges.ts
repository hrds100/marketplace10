...
export const flowEdges: Edge[] = [
  ...
  E('social-otp', 'social-login', 'otp-verify', 'New user → phone step'),
  E('social-link', 'social-login', 'link-social-identity', 'Existing email user'),
  animated('link-fd', 'link-social-identity', 'free-dashboard', 'Rekeyed + signed in'),
  E('pc-signin', 'particle-callback', 'social-login', 'Stale bookmark → /signin'),
