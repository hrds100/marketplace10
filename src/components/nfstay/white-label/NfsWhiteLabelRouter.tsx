...
// Renders white-label routes when on a subdomain/custom domain OR nfstay.app (platform mode),
...
import NfsWlBooking from '@/pages/nfstay/white-label/NfsWlBooking';
import NfsWlPayment from '@/pages/nfstay/white-label/NfsWlPayment';
...
export default function NfsWhiteLabelRouter({ children }: Props) {
  ...
  // White-label mode (includes nfstay.app platform + subdomains + custom domains)
  return (
    <Routes>
      <Route element={<NfsWhiteLabelLayout />}>
        ...
        <Route path="/booking/:id" element={<NfsWlBooking />} />
        <Route path="/payment" element={<NfsWlPayment />} />
