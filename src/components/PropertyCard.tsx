  ...
  return (
    <div data-feature="DEALS__PROPERTY_CARD" className="bg-card border border-border rounded-2xl overflow-hidden card-hover flex flex-col">
      ...
      <div className="p-3.5 pt-3 flex flex-col flex-1">
        ...
        {/* Contact buttons - Bayut-style: soft tinted, Email(icon+text) | Visit Listing | WhatsApp(icon only) */}
        <div className="flex gap-2 mt-3">
          {forceSignUp ? (
            <>
              <button data-feature="DEALS__PROPERTY_CARD_EMAIL" onClick={handleAction}
                className="flex-1 h-[44px] rounded-xl inline-flex items-center justify-center gap-2 text-[13px] font-semibold transition-all hover:brightness-[0.96]"
                style={{ backgroundColor: '#E8F0EF', color: '#2D6A5F' }}>
                <Mail className="w-[17px] h-[17px]" strokeWidth={1.8} /> Email
              </button>
              <button data-feature="DEALS__PROPERTY_CARD_VIEW" onClick={handleAction}
                className="flex-1 h-[44px] rounded-xl inline-flex items-center justify-center text-[13px] font-semibold transition-all hover:brightness-[0.96]"
                style={{ backgroundColor: '#1E9A80', color: '#fff' }}>
                Visit Listing
              </button>
              <button onClick={handleAction}
                className="h-[44px] w-[52px] flex-shrink-0 rounded-xl inline-flex items-center justify-center transition-all hover:brightness-[0.96]"
                style={{ backgroundColor: '#E7F5EE' }}>
