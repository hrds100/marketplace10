  ...
  return (
    <div data-feature="DEALS__PROPERTY_CARD" className="bg-card border border-border rounded-2xl overflow-hidden card-hover flex flex-col">
      ...
      <div className="p-3.5 pt-3 flex flex-col flex-1">
        ...
        {/* Contact row: Email(icon) + WhatsApp(icon) side by side */}
        <div className="flex gap-2 mt-3">
          {forceSignUp ? (
            <>
              <button data-feature="DEALS__PROPERTY_CARD_EMAIL" onClick={handleAction}
                className="flex-1 h-[44px] rounded-xl inline-flex items-center justify-center transition-all hover:brightness-[0.96]"
                style={{ backgroundColor: '#E8F0EF' }}>
                <Mail className="w-[19px] h-[19px]" strokeWidth={1.8} style={{ color: '#2D6A5F' }} />
              </button>
              <button onClick={handleAction}
                className="flex-1 h-[44px] rounded-xl inline-flex items-center justify-center transition-all hover:brightness-[0.96]"
        ...
        {/* Visit Listing - full width below */}
        <div className="mt-2">
          {forceSignUp ? (
            <button data-feature="DEALS__PROPERTY_CARD_VIEW" onClick={handleAction}
              className="w-full h-[38px] rounded-xl inline-flex items-center justify-center text-[13px] font-semibold transition-all hover:opacity-90"
