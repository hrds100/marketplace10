...
function ReservationCard({ r }: { r: MockReservation }) {
  ...
  return (
    <Link to={`/nfstay/traveler/reservation/${r.id}`} className="flex gap-4 bg-card border border-border rounded-2xl p-4 hover:border-primary/30 hover:shadow-sm transition-all group">
