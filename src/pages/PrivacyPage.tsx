    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-[720px] mx-auto px-6 py-16">
        ...
        <div className="prose prose-sm text-muted-foreground space-y-4">
          ...
          <p className="text-sm leading-relaxed">We collect information you provide directly: name, email address, WhatsApp number, and payment details processed via SamCart. We also collect usage data including pages viewed, features used, and device information.</p>
          ...
          <p className="text-sm leading-relaxed">We do not sell your personal data. We share information only with: payment processors (SamCart), landlords when you initiate contact, and service providers who assist our operations.</p>
