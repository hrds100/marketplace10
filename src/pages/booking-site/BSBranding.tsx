...
import { Globe, Smartphone, Monitor, Copy, Check, Palette, Type, Mail, Image, Link2, Loader2, AlertCircle, CheckCircle2 } from 'lucide-react';
import PaymentSheet from '@/components/PaymentSheet';
import BookingSitePreview from '@/pages/BookingSitePreview';
...
export default function BSBranding() {
