...
serve(async (req) => {
  ...
  try {
    ...
    // 5. WhatsApp auto-reply — NOT handled here.
    // Email inquiries get an email confirmation (step 6 below).
    // WhatsApp inquiries go through GHL workflow cf089a15 which handles the reply.
