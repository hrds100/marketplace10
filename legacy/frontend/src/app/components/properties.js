...
const Properties = ({ disableClick = false }) => {
    ...
    <div className="w-full">
      <div className="pb-2.5 pt-6 xl:pb-1">
        <div className="mb-6 flex justify-center items-center w-full">
          <h4 className="text-4xl sm:text-4xl md:text-[44px] md:leading-[60px] transition-all font-bold max-w-3xl text-center text-black ">
            Own a Share of Rent-to-Rent Deals with Low Entry Costs and High
            Returns
          </h4>
        </div>
