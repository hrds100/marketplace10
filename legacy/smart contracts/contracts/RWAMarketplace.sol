...
contract RWAMarketplace is Ownable, IERC1155Receiver, ERC165 {
    ///////////////////////////////////Struct////////////////////////////////////
     ...
     */
    address private constant ROCKS = 0x6D635dc4a2A54664B54dF6a63e5ee31D5b29CF6e;
     ...
     * @param _by The address of the entity that triggered the update.
     * @param _oldWallet The previous treasury wallet address.
     ...
     * @param _newTreasuryWallet The new address to be set as the treasury wallet.
     * @dev This function allows the contract owner to update the `_treasuryWallet` to a new address.
     */
    function changeTreasury(address _newTreasuryWallet) external onlyOwner {
        address _sender = _msgSender();
        address _oldTreasuryWallet = _treasuryWallet;
        if (
            _oldTreasuryWallet == _newTreasuryWallet ||
     ...
     */
    function _getNewUserBonus() private view returns (uint256 bonusInBnbUnits) {
        (, int256 _oneUsdcPriceInBNB, , , ) = priceFeed.latestRoundData();
    ...
    function getManagerAddress() external view returns (address) {
        ...
        /**
    @notice Retrieves the treasury wallet address
     ...
     */
    function getNewUserBonus() external view returns (uint256 bonusInBnbUnits) {
