...
contract BuyLP is Ownable {
     ...
     */
    address private constant LP = 0x2397C1722CCb6934BECF579351685A56030EA8F7;
    ...
    /**
     * @dev Address of the Wrapped BNB token (WBNB) contract.
     */
    ...
    function _makePath(
        address _currency
    ) private pure returns (address[] memory _path) {
        _path = new address[](2);
