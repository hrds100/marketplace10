...
- Controlled by `properties.nda_required` boolean (column remains in DB, UI toggle removed from admin as of 2026-04-02 - NDA now managed per-inquiry in The Gates).
